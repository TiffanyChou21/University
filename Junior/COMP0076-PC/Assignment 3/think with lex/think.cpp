	...
	case 8:
		{
			...
			{
#line 63 ".\\think.y"
(*(YYSTYPE YYFAR*)yyvalptr) = token_table.get(yyattribute(1 - 1));
#line 303 "think.cpp"
			}
		}
		break;
	case 9:
		{
			...
			{
#line 64 ".\\think.y"
token_table.set(yyattribute(1 - 3), yyattribute(3 - 3)); (*(YYSTYPE YYFAR*)yyvalptr)=yyattribute(3 - 3); 
#line 316 "think.cpp"
			}
		}
		break;
